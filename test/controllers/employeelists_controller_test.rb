...
class EmployeelistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employeelist" do
    assert_difference("Employeelist.count") do
      post employeelists_url, params: { employeelist: { age: @employeelist.age, designation: @employeelist.designation, employee_name: @employeelist.employee_name, gender: @employeelist.gender, string: @employeelist.string } }
    end
  ...
  test "should update employeelist" do
    patch employeelist_url(@employeelist), params: { employeelist: { age: @employeelist.age, designation: @employeelist.designation, employee_name: @employeelist.employee_name, gender: @employeelist.gender, string: @employeelist.string } }
